...
CREATE COLUMNSTORE INDEX [ncci_TBL_PICKLIST_VALUE]
    ON [Eteam_Ora].[TBL_PICKLIST_VALUE]([PICKLIST_VALUE_ID], [PICKLIST_ID], [PICKLIST_VALUE], [IS_EDITABLE], [IS_ENABLED], [SORT_ORDER], [COLOR_KEY], [COLOR_IMG_KEY], [IS_REMOTE], [IS_INTERNATIONAL]);
