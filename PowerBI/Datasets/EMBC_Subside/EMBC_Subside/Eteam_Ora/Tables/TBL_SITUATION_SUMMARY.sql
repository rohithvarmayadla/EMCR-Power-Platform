...
CREATE COLUMNSTORE INDEX [ncci_TBL_SITUATION_SUMMARY]
    ON [Eteam_Ora].[TBL_SITUATION_SUMMARY]([GLOBAL_SUMMARY_ID], [SUMMARY_ID], [REPORT_ID], [ENTERED_BY], [ENTRY_DATE], [ORGANIZATION], [CREATED_BY], [CREATION_DATE], [MODIFIED_BY], [MODIFICATION_DATE], [DELETED_BY], [DELETION_DATE], [STATUS]);
