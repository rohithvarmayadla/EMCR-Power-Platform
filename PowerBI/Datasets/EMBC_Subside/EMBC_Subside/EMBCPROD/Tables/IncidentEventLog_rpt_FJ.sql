CREATE TABLE [EMBCPROD].[IncidentEventLog_rpt_FJ] (
    ...
    [Event_Status]          NVARCHAR (703) NOT NULL,
    [Event_Severity]        NVARCHAR (300) NULL,
    [Event_Prognosis]       NVARCHAR (703) NOT NULL,
...
CREATE CLUSTERED COLUMNSTORE INDEX [CCI_INCIDENTEVENTLOG_RPT]
    ON [EMBCPROD].[IncidentEventLog_rpt_FJ];
