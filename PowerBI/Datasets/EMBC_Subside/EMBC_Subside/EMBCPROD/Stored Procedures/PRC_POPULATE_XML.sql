CREATE PROCEDURE [EMBCPROD].[PRC_POPULATE_XML]  
AS 
   BEGIN
      ...
      DECLARE
          C1 CURSOR LOCAL FOR 
            SELECT TBL_CUSTOM_FORM_INSTANCE.GLOBAL_REPORT_ID, TBL_CUSTOM_FORM_INSTANCE.REPORT_ID, TBL_CUSTOM_FORM_INSTANCE.CUSTOM_FORM_ID, TBL_CUSTOM_FORM_INSTANCE.FREVVO_DATA
            FROM EMBCPROD.TBL_CUSTOM_FORM_INSTANCE
            WHERE TBL_CUSTOM_FORM_INSTANCE.FREVVO_DATA IS NOT NULL AND TBL_CUSTOM_FORM_INSTANCE.FREVVO_XML_DATA IS NULL
      ...
      WHILE 1 = 1
         ...
         BEGIN
            ...
            FETCH C1
                INTO @V_GLOBAL_REPORT_ID, @V_REPORT_ID, @V_CUSTOM_FORM_ID, @V_CLOB
            ...
            *   dbms_output.put_line('v_custom_form_id = ' || v_custom_form_id);
            ...
            */
            ...
            BEGIN
               ...
               BEGIN TRY
                  ...
                  SET @V_CMD = 'UPDATE TBL_CUSTOM_FORM_INSTANCE SET FREVVO_XML_DATA = :1 WHERE GLOBAL_REPORT_ID = :2 AND REPORT_ID = :3 AND CUSTOM_FORM_ID = :4'
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.PRC_POPULATE_XML', @level0type = N'SCHEMA', @level0name = N'EMBCPROD', @level1type = N'PROCEDURE', @level1name = N'PRC_POPULATE_XML';
