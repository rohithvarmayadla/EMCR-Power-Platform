CREATE PROCEDURE [EMBCPROD].[PRC_LOAD_GLOBAL_REPORTIDS]  
   @P_GLOBAL_REPORT_IDS varchar(max)
AS 
   BEGIN
      ...
      SET @NO_TEMP_TABLE$exception = N'local:oracle:{EMBCPROD|PRC_LOAD_GLOBAL_REPORTIDS}:000:NO_TEMP_TABLE'

      DECLARE
         @ETEXT varchar(2000), 
         @V_COUNT int, 
         @V_GLOBAL_TABLE varchar(256) = 'GBL_GLOBAL_REPORT_IDS', 
         @V_SQL varchar(max)
      ...
      */
      ...
      BEGIN
         ...
         BEGIN TRY
            ...
            *   EXECUTE IMMEDIATE 'INSERT INTO GBL_REPORT_IDS (GLOBAL_REPORT_ID) (SELECT COLUMN_VALUE FROM XMLTABLE( (''"'' || REPLACE(:x , '','', ''","'') || ''"'') ) )' USING p_global_report_ids;
            */
            SET @V_SQL = REGEXP_REPLACE(@P_GLOBAL_REPORT_IDS, ',', '","')
            */
            ...
            *
            ...
            EXECUTE ('INSERT INTO GBL_GLOBAL_REPORT_IDS (GLOBAL_REPORT_ID) (SELECT COLUMN_VALUE FROM XMLTABLE( ' + ISNULL(@V_SQL, '') + '))')
            */
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.PRC_LOAD_GLOBAL_REPORTIDS', @level0type = N'SCHEMA', @level0name = N'EMBCPROD', @level1type = N'PROCEDURE', @level1name = N'PRC_LOAD_GLOBAL_REPORTIDS';
