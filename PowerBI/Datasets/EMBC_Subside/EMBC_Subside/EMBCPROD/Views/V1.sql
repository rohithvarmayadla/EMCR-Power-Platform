...
AS 
   ...
   WHERE 
      ...
      EIA_REPT.STATUS NOT IN ( 'A', 'C', 'D' )

GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.V1', @level0type = N'SCHEMA', @level0name = N'EMBCPROD', @level1type = N'VIEW', @level1name = N'V1';
