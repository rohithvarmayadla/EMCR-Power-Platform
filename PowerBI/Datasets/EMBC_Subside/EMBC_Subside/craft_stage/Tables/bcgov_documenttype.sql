CREATE TABLE [craft_stage].[bcgov_documenttype] (
    [bcgov_documenttypeid]         UNIQUEIDENTIFIER NOT NULL,
    [bcgov_isportalaccessible]     INT              NULL,
    [bcgov_isportalaccessiblename] NVARCHAR (255)   NULL,
    ...
    CONSTRAINT [PK_bcgov_documenttype] PRIMARY KEY CLUSTERED ([bcgov_documenttypeid] ASC)
);
