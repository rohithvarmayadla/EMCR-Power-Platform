CREATE TABLE [craft_stage].[drr_fiscalyear] (
    ...
    [drr_fiscalyearend]          DATETIME         NULL,
    [drr_fiscalyearid]           UNIQUEIDENTIFIER NOT NULL,
    [drr_fiscalyearstart]        DATETIME         NULL,
    ...
    CONSTRAINT [PK_drr_fiscalyear] PRIMARY KEY CLUSTERED ([drr_fiscalyearid] ASC)
);
