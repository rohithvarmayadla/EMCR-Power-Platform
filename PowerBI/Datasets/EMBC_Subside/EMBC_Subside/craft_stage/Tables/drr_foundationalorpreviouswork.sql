CREATE TABLE [craft_stage].[drr_foundationalorpreviouswork] (
    ...
    [drr_foundationalorpreviousworkid] UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_foundationalorpreviouswork] PRIMARY KEY CLUSTERED ([drr_foundationalorpreviousworkid] ASC)
);
