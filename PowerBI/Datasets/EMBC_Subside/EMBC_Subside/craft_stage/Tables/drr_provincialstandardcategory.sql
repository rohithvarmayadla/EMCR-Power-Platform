CREATE TABLE [craft_stage].[drr_provincialstandardcategory] (
    ...
    [drr_provincialstandardcategoryid] UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_provincialstandardcategory] PRIMARY KEY CLUSTERED ([drr_provincialstandardcategoryid] ASC)
);
