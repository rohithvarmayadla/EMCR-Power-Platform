CREATE TABLE [craft_stage].[drr_projectcapacitychallengeitem] (
    ...
    [drr_projectcapacitychallenge]         UNIQUEIDENTIFIER NULL,
    [drr_projectcapacitychallengecomments] NVARCHAR (200)   NULL,
    [drr_projectcapacitychallengeitemid]   UNIQUEIDENTIFIER NOT NULL,
    [drr_projectcapacitychallengename]     NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_drr_projectcapacitychallengeitem] PRIMARY KEY CLUSTERED ([drr_projectcapacitychallengeitemid] ASC)
);
