CREATE TABLE [craft_stage].[drr_impactedoraffectedparty] (
    ...
    [drr_impactedoraffectedpartyid] UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_impactedoraffectedparty] PRIMARY KEY CLUSTERED ([drr_impactedoraffectedpartyid] ASC)
);
