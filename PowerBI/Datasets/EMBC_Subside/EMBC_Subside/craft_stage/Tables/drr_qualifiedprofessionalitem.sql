CREATE TABLE [craft_stage].[drr_qualifiedprofessionalitem] (
    ...
    [drr_qualifiedprofessional]         UNIQUEIDENTIFIER NULL,
    [drr_qualifiedprofessionalcomments] NVARCHAR (MAX)   NULL,
    [drr_qualifiedprofessionalitemid]   UNIQUEIDENTIFIER NOT NULL,
    [drr_qualifiedprofessionalname]     NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_drr_qualifiedprofessionalitem] PRIMARY KEY CLUSTERED ([drr_qualifiedprofessionalitemid] ASC)
);
