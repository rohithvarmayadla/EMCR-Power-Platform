CREATE TABLE [craft_stage].[drr_foundationalorpreviousworkitem] (
    ...
    [drr_foundationalorpreviouswork]         UNIQUEIDENTIFIER NULL,
    [drr_foundationalorpreviousworkcomments] NVARCHAR (200)   NULL,
    [drr_foundationalorpreviousworkitemid]   UNIQUEIDENTIFIER NOT NULL,
    [drr_foundationalorpreviousworkname]     NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_drr_foundationalorpreviousworkitem] PRIMARY KEY CLUSTERED ([drr_foundationalorpreviousworkitemid] ASC)
);
