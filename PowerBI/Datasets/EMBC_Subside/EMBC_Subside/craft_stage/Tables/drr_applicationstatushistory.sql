CREATE TABLE [craft_stage].[drr_applicationstatushistory] (
    ...
    [drr_applicationstatushistoryid] UNIQUEIDENTIFIER NOT NULL,
    [drr_name]                       NVARCHAR (100)   NULL,
    [drr_newstatusreason]            NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_] PRIMARY KEY CLUSTERED ([drr_applicationstatushistoryid] ASC)
);
