CREATE TABLE [craft_stage].[drr_costconsideration] (
    ...
    [drr_costconsiderationid]    UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_costconsideration] PRIMARY KEY CLUSTERED ([drr_costconsiderationid] ASC)
);
