CREATE TABLE [craft_stage].[drr_projectcapacitychallenge] (
    ...
    [drr_projectcapacitychallengeid] UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_projectcapacitychallenge] PRIMARY KEY CLUSTERED ([drr_projectcapacitychallengeid] ASC)
);
