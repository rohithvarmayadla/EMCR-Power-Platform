CREATE TABLE [craft_stage].[drr_projectactivity] (
    ...
    [drr_projectactivityid]      UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_projectactivity] PRIMARY KEY CLUSTERED ([drr_projectactivityid] ASC)
);
