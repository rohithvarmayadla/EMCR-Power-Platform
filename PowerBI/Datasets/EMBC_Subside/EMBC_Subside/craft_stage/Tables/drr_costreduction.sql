CREATE TABLE [craft_stage].[drr_costreduction] (
    ...
    [drr_costreductionid]        UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_costreduction] PRIMARY KEY CLUSTERED ([drr_costreductionid] ASC)
);
