CREATE TABLE [craft_stage].[drr_resiliencyitem] (
    ...
    [drr_resiliency]             UNIQUEIDENTIFIER NULL,
    [drr_resiliencycomments]     NVARCHAR (MAX)   NULL,
    [drr_resiliencyitemid]       UNIQUEIDENTIFIER NOT NULL,
    [drr_resiliencyname]         NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_drr_resiliencyitem] PRIMARY KEY CLUSTERED ([drr_resiliencyitemid] ASC)
);
