CREATE TABLE [craft_stage].[drr_provincialstandard] (
    ...
    [drr_category]               UNIQUEIDENTIFIER NULL,
    [drr_categoryname]           NVARCHAR (200)   NULL,
    [drr_name]                   NVARCHAR (200)   NULL,
    [drr_provincialstandardid]   UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_provincialstandard] PRIMARY KEY CLUSTERED ([drr_provincialstandardid] ASC)
);
