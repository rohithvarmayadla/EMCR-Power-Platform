CREATE TABLE [craft_stage].[drr_qualifiedprofessional] (
    ...
    [drr_qualifiedprofessionalid] UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_qualifiedprofessional] PRIMARY KEY CLUSTERED ([drr_qualifiedprofessionalid] ASC)
);
