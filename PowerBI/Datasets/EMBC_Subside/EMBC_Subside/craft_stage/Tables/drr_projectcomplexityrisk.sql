CREATE TABLE [craft_stage].[drr_projectcomplexityrisk] (
    ...
    [drr_projectcomplexityriskid] UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_projectcomplexityrisk] PRIMARY KEY CLUSTERED ([drr_projectcomplexityriskid] ASC)
);
