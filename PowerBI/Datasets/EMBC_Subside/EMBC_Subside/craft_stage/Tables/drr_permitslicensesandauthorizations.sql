CREATE TABLE [craft_stage].[drr_permitslicensesandauthorizations] (
    ...
    [drr_permitslicensesandauthorizationsid] UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_permitslicensesandauthorizations] PRIMARY KEY CLUSTERED ([drr_permitslicensesandauthorizationsid] ASC)
);
