CREATE TABLE [craft_stage].[drr_subjectmatterexpert] (
    ...
    [drr_subjectmatterexpertid]  UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_subjectmatterexpert] PRIMARY KEY CLUSTERED ([drr_subjectmatterexpertid] ASC)
);
