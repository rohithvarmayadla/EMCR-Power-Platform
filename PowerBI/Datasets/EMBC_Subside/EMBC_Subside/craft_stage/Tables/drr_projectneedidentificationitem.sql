CREATE TABLE [craft_stage].[drr_projectneedidentificationitem] (
    ...
    [drr_projectneedidentification]       UNIQUEIDENTIFIER NULL,
    [drr_projectneedidentificationitemid] UNIQUEIDENTIFIER NOT NULL,
    [drr_projectneedidentificationname]   NVARCHAR (100)   NULL,
    [drr_projectneedidentifiedcomments]   NVARCHAR (200)   NULL,
    ...
    CONSTRAINT [PK_drr_projectneedidentificationitem] PRIMARY KEY CLUSTERED ([drr_projectneedidentificationitemid] ASC)
);
