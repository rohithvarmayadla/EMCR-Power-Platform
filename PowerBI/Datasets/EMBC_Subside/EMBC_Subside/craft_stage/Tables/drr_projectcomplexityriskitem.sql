CREATE TABLE [craft_stage].[drr_projectcomplexityriskitem] (
    ...
    [drr_projectcomplexityrisk]             UNIQUEIDENTIFIER NULL,
    [drr_projectcomplexityriskitemcomments] NVARCHAR (MAX)   NULL,
    [drr_projectcomplexityriskitemid]       UNIQUEIDENTIFIER NOT NULL,
    [drr_projectcomplexityriskname]         NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_drr_projectcomplexityriskitem] PRIMARY KEY CLUSTERED ([drr_projectcomplexityriskitemid] ASC)
);
