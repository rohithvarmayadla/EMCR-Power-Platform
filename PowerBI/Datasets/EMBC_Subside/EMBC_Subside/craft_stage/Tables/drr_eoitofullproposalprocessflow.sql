CREATE TABLE [craft_stage].[drr_eoitofullproposalprocessflow] (
    [activestageid]                 UNIQUEIDENTIFIER NULL,
    [activestageidname]             NVARCHAR (100)   NULL,
    [activestagestartedon]          DATETIME         NULL,
    [bpf_drr_applicationid]         UNIQUEIDENTIFIER NULL,
    [bpf_drr_applicationidname]     NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_drr_eoitofullproposalprocessflow] PRIMARY KEY CLUSTERED ([businessprocessflowinstanceid] ASC)
);
