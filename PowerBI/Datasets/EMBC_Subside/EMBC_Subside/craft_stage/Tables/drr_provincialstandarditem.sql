CREATE TABLE [craft_stage].[drr_provincialstandarditem] (
    ...
    [drr_provincialstandard]             UNIQUEIDENTIFIER NULL,
    [drr_provincialstandardcategory]     UNIQUEIDENTIFIER NULL,
    [drr_provincialstandardcategoryname] NVARCHAR (200)   NULL,
    [drr_provincialstandarditemcomments] NVARCHAR (MAX)   NULL,
    [drr_provincialstandarditemid]       UNIQUEIDENTIFIER NOT NULL,
    [drr_provincialstandardname]         NVARCHAR (200)   NULL,
    ...
    CONSTRAINT [PK_drr_provincialstandarditem] PRIMARY KEY CLUSTERED ([drr_provincialstandarditemid] ASC)
);
