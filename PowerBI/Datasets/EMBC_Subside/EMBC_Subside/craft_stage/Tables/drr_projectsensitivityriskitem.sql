CREATE TABLE [craft_stage].[drr_projectsensitivityriskitem] (
    ...
    [drr_projectsensitivityrisk]         UNIQUEIDENTIFIER NULL,
    [drr_projectsensitivityriskcomments] NVARCHAR (200)   NULL,
    [drr_projectsensitivityriskitemid]   UNIQUEIDENTIFIER NOT NULL,
    [drr_projectsensitivityriskname]     NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_drr_projectsensitivityriskitem] PRIMARY KEY CLUSTERED ([drr_projectsensitivityriskitemid] ASC)
);
