CREATE TABLE [craft_stage].[drr_projectneedidentification] (
    ...
    [drr_projectneedidentificationid] UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_projectneedidentification] PRIMARY KEY CLUSTERED ([drr_projectneedidentificationid] ASC)
);
