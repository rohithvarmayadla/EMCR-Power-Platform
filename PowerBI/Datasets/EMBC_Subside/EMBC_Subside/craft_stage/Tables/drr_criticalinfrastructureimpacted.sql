CREATE TABLE [craft_stage].[drr_criticalinfrastructureimpacted] (
    ...
    [drr_criticalinfrastructureimpactedid] UNIQUEIDENTIFIER NOT NULL,
    [drr_impacttothatinfrastructure]       NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_drr_criticalinfrastructureimpacted] PRIMARY KEY CLUSTERED ([drr_criticalinfrastructureimpactedid] ASC)
);
