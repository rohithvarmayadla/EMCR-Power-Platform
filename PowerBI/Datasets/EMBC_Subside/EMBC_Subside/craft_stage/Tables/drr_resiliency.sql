CREATE TABLE [craft_stage].[drr_resiliency] (
    ...
    [drr_resiliencyid]           UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_resiliency] PRIMARY KEY CLUSTERED ([drr_resiliencyid] ASC)
);
