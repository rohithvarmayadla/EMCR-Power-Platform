CREATE TABLE [craft_stage].[contact] (
    ...
    [drr_contacttype]                  INT              NULL,
    [drr_contacttypename]              NVARCHAR (255)   NULL,
    [drr_phonenumber]                  NVARCHAR (50)    NULL,
    [drr_sme_type]                     UNIQUEIDENTIFIER NULL,
    [drr_sme_typename]                 NVARCHAR (100)   NULL,
    [drr_userid]                       NVARCHAR (100)   NULL,
