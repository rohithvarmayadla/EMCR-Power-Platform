CREATE TABLE [craft_stage].[drr_costreductionitem] (
    ...
    [drr_costreduction]             UNIQUEIDENTIFIER NULL,
    [drr_costreductionitemcomments] NVARCHAR (200)   NULL,
    [drr_costreductionitemid]       UNIQUEIDENTIFIER NOT NULL,
    [drr_costreductionname]         NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_drr_costreductionitem] PRIMARY KEY CLUSTERED ([drr_costreductionitemid] ASC)
);
