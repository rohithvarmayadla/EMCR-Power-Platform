CREATE TABLE [craft_stage].[drr_projectreadinessriskitem] (
    ...
    [drr_projectreadinessrisk]         UNIQUEIDENTIFIER NULL,
    [drr_projectreadinessriskcomments] NVARCHAR (200)   NULL,
    [drr_projectreadinessriskitemid]   UNIQUEIDENTIFIER NOT NULL,
    [drr_projectreadinessriskname]     NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_drr_projectreadinessriskitem] PRIMARY KEY CLUSTERED ([drr_projectreadinessriskitemid] ASC)
);
