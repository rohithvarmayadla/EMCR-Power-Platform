CREATE TABLE [craft_stage].[drr_legaldeclaration] (
    ...
    [drr_declarationtext]        NVARCHAR (MAX)   NULL,
    [drr_declarationtype]        INT              NULL,
    [drr_declarationtypename]    NVARCHAR (255)   NULL,
    [drr_enddate]                DATETIME         NULL,
    [drr_legaldeclarationid]     UNIQUEIDENTIFIER NOT NULL,
    [drr_name]                   NVARCHAR (100)   NULL,
    [drr_startdate]              DATETIME         NULL,
    ...
    CONSTRAINT [PK_drr_legaldeclaration] PRIMARY KEY CLUSTERED ([drr_legaldeclarationid] ASC)
);
