CREATE TABLE [craft_stage].[drr_cobenefititem] (
    ...
    [drr_cobenefit]              UNIQUEIDENTIFIER NULL,
    [drr_cobenefitcomments]      NVARCHAR (200)   NULL,
    [drr_cobenefititemid]        UNIQUEIDENTIFIER NOT NULL,
    [drr_cobenefitname]          NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_drr_cobenefititem] PRIMARY KEY CLUSTERED ([drr_cobenefititemid] ASC)
);
