CREATE TABLE [craft_stage].[drr_region] (
    ...
    [drr_ministry]               INT              NULL,
    [drr_ministryname]           NVARCHAR (255)   NULL,
    [drr_name]                   NVARCHAR (100)   NULL,
    [drr_regionid]               UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_region] PRIMARY KEY CLUSTERED ([drr_regionid] ASC)
);
