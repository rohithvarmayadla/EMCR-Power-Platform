CREATE TABLE [craft_stage].[drr_impactedoraffectedpartyitem] (
    ...
    [drr_impactedoraffectedparty]         UNIQUEIDENTIFIER NULL,
    [drr_impactedoraffectedpartycomments] NVARCHAR (200)   NULL,
    [drr_impactedoraffectedpartyitemid]   UNIQUEIDENTIFIER NOT NULL,
    [drr_impactedoraffectedpartyname]     NVARCHAR (100)   NULL,
    ...
    CONSTRAINT [PK_drr_impactedoraffectedpartyitem] PRIMARY KEY CLUSTERED ([drr_impactedoraffectedpartyitemid] ASC)
);
