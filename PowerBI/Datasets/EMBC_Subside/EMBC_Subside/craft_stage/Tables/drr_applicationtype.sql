CREATE TABLE [craft_stage].[drr_applicationtype] (
    ...
    [drr_applicationtypeid]      UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_applicationtype] PRIMARY KEY CLUSTERED ([drr_applicationtypeid] ASC)
);
