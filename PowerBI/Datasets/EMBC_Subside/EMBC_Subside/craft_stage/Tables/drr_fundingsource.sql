CREATE TABLE [craft_stage].[drr_fundingsource] (
    ...
    [drr_describethefundingsource] NVARCHAR (100)   NULL,
    [drr_estimated_amount]         NUMERIC (38, 4)  NULL,
    [drr_estimated_amount_base]    NUMERIC (38, 4)  NULL,
    [drr_fundingsourceid]          UNIQUEIDENTIFIER NOT NULL,
    [drr_name]                     NVARCHAR (100)   NULL,
    [drr_typeoffunding]            INT              NULL,
    [drr_typeoffundingname]        NVARCHAR (255)   NULL,
    ...
    CONSTRAINT [PK_drr_fundingsource] PRIMARY KEY CLUSTERED ([drr_fundingsourceid] ASC)
);
