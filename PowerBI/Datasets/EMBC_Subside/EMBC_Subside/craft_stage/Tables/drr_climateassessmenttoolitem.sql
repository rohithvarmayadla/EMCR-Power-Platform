CREATE TABLE [craft_stage].[drr_climateassessmenttoolitem] (
    ...
    [drr_climateassessmenttool]          UNIQUEIDENTIFIER NULL,
    [drr_climateassessmenttoolitemid]    UNIQUEIDENTIFIER NOT NULL,
    [drr_climateassessmenttoolname]      NVARCHAR (100)   NULL,
    [drr_climateassessmmenttoolcomments] NVARCHAR (MAX)   NULL,
    ...
    CONSTRAINT [PK_drr_climateassessmenttoolitem] PRIMARY KEY CLUSTERED ([drr_climateassessmenttoolitemid] ASC)
);
