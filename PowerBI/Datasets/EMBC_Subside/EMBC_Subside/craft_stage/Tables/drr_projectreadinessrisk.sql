CREATE TABLE [craft_stage].[drr_projectreadinessrisk] (
    ...
    [drr_projectreadinessriskid] UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_projectreadinessrisk] PRIMARY KEY CLUSTERED ([drr_projectreadinessriskid] ASC)
);
