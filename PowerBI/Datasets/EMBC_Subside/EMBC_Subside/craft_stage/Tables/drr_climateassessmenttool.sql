CREATE TABLE [craft_stage].[drr_climateassessmenttool] (
    ...
    [drr_climateassessmenttoolid] UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_climateassessmenttool] PRIMARY KEY CLUSTERED ([drr_climateassessmenttoolid] ASC)
);
