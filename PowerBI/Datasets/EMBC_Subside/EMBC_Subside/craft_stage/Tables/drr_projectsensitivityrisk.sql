CREATE TABLE [craft_stage].[drr_projectsensitivityrisk] (
    ...
    [drr_projectsensitivityriskid] UNIQUEIDENTIFIER NOT NULL,
    ...
    CONSTRAINT [PK_drr_projectsensitivityrisk] PRIMARY KEY CLUSTERED ([drr_projectsensitivityriskid] ASC)
);
