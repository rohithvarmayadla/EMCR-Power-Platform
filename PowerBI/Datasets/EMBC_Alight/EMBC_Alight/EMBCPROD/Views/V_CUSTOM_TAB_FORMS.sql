CREATE VIEW EMBCPROD.V_CUSTOM_TAB_FORMS (
   FREVVO_ID, 
   GLOBAL_REPORT_ID, 
   FORM_NAME, 
   INSTANCE_ID, 
...
AS 
   ...
   WHERE 
      ...
      CFR.REPORT_TYPE_ID IS NOT NULL
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.V_CUSTOM_TAB_FORMS', @level0type = N'SCHEMA', @level0name = N'EMBCPROD', @level1type = N'VIEW', @level1name = N'V_CUSTOM_TAB_FORMS';
