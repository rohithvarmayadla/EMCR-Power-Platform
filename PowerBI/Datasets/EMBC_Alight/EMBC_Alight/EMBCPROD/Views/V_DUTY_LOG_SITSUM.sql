CREATE VIEW EMBCPROD.V_DUTY_LOG_SITSUM (
   REPORT_NAME, 
   UNIQUE_KEY, 
   REPORT_VERSION, 
   FOREIGN_DOC, 
...
AS 
   ...
   WHERE 
      ...
      REPT.REPORT_TYPE LIKE 'duty_log'
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.V_DUTY_LOG_SITSUM', @level0type = N'SCHEMA', @level0name = N'EMBCPROD', @level1type = N'VIEW', @level1name = N'V_DUTY_LOG_SITSUM';
