CREATE VIEW EMBCPROD.V_AGENCY_SITSUM (
   REPORT_NAME, 
   UNIQUE_KEY, 
   REPORT_VERSION, 
   FOREIGN_DOC, 
...
AS 
   ...
   WHERE 
      ...
      REPT.REPORT_TYPE LIKE 'agency_sitrep'
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.V_AGENCY_SITSUM', @level0type = N'SCHEMA', @level0name = N'EMBCPROD', @level1type = N'VIEW', @level1name = N'V_AGENCY_SITSUM';
