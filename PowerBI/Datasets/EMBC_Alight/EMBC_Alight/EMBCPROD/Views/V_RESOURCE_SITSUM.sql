CREATE VIEW EMBCPROD.V_RESOURCE_SITSUM (
   REPORT_NAME, 
   UNIQUE_KEY, 
   REPORT_VERSION, 
   FOREIGN_DOC, 
...
AS 
   ...
   WHERE 
      ...
      REPT.REPORT_TYPE LIKE 'resource_request'
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.V_RESOURCE_SITSUM', @level0type = N'SCHEMA', @level0name = N'EMBCPROD', @level1type = N'VIEW', @level1name = N'V_RESOURCE_SITSUM';
