CREATE VIEW EMBCPROD.V_CUSTOM_FORM_SITSUM (
   REPORT_NAME, 
   UNIQUE_KEY, 
   REPORT_VERSION, 
   FOREIGN_DOC, 
...
AS 
   SELECT 
      ...
      CASE SS.CREATED_BY
         ...
         ELSE 'No'
      END AS FOREIGN_DOC, 
      ssma_oracle.dbms_lob$substr_clob(SS.SUMMARY, 8000, 1) AS SUMMARY, 
      SS.ENTERED_BY, 
      SS.ENTRY_DATE, 
      SS.ORGANIZATION, 
      CASE 
   ...
   WHERE 
      ...
      REPT.STATUS = 'A' AND 
      REPT.REPORT_TYPE LIKE 'custom_form'
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.V_CUSTOM_FORM_SITSUM', @level0type = N'SCHEMA', @level0name = N'EMBCPROD', @level1type = N'VIEW', @level1name = N'V_CUSTOM_FORM_SITSUM';
