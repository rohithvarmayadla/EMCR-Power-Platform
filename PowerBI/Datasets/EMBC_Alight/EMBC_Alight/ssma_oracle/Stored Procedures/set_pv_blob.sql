create procedure [ssma_oracle].[set_pv_blob] (@owner sysname, @package nvarchar(32), @name nvarchar(128),@value varbinary(max))
as begin
...
if @@trancount=0 begin
 ...
 set c_value=null,v_value=null,nc_value=null,b_value=@value
 ...
 values(@get_active_spid,@get_active_login_time,@full_name,null,null,null,@value)
end else begin
 declare @dbname sysname
  set @dbname = db_name()
 exec master..xp_ora2ms_exec2 @get_active_spid,@get_active_login_time,@dbname,'ssma_oracle','set_pv_blob',@owner,@package,@name,@value
end
end