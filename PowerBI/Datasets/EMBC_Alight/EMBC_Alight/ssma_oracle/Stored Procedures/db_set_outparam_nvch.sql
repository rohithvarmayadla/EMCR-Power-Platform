/****** Object:  StoredProcedure [ssma_oracle].[db_set_outparam_nvch]    Script Date: 07/06/2007 13:24:49 ******/
create proc [ssma_oracle].[db_set_outparam_nvch] @ordinal int,@val nvarchar(max)
as
set nocount on
if @@trancount=0 begin
delete db_LOB_output_session where ordinal=@ordinal
insert db_LOB_output_session(ordinal,nc_value) values(@ordinal,@val)
end
else begin
