create procedure [ssma_oracle].[set_pv] (@owner sysname, @package nvarchar(32), @name nvarchar(128),@value sql_variant)
as begin
...
if @@trancount=0 begin
 ...
 declare @dbname sysname
  set @dbname = db_name()
 exec master..xp_ora2ms_exec2 @get_active_spid,@get_active_login_time,@dbname,'ssma_oracle','set_value_variant',@full_name,@value
end
end