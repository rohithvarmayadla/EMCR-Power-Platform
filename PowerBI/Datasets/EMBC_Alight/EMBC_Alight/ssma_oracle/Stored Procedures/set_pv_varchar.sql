create procedure [ssma_oracle].[set_pv_varchar] (@owner sysname, @package nvarchar(32), @name nvarchar(128),@value varchar(8000))
as begin
...
if @@trancount=0 begin
 ...
 declare @dbname sysname 
  set @dbname = db_name()
 exec master..xp_ora2ms_exec2 @get_active_spid,@get_active_login_time,@dbname,'ssma_oracle','set_pv_varchar',@owner,@package,@name,@value
end
