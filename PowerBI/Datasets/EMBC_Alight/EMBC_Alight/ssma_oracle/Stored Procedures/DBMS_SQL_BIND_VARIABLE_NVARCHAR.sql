------------\/-- DBMS_SQL_BIND_VARIABLE_nvarchar --\/-------------

CREATE PROCEDURE [ssma_oracle].[DBMS_SQL_BIND_VARIABLE_NVARCHAR]
    @cursor int, @column_name varchar(128), @v NVARCHAR(4000)
    AS
  BEGIN
    SET NOCOUNT ON
    ...
    ELSE
      ...
      VALUES
        (@cursor, @column_name, 'NVARCHAR(4000)', @v, NULL, NULL, NULL)
  END