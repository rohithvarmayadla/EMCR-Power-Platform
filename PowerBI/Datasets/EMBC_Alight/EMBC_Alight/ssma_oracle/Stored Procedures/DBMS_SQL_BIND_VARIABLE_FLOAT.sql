------------\/-- DBMS_SQL_BIND_VARIABLE_float --\/-------------

CREATE PROCEDURE [ssma_oracle].[DBMS_SQL_BIND_VARIABLE_FLOAT]
    @cursor int, @column_name varchar(128), @v FLOAT
    AS
  BEGIN
    SET NOCOUNT ON
    ...
    ELSE
      ...
      VALUES
        (@cursor, @column_name, 'FLOAT', @v, NULL, NULL, NULL)
  END