...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_TARGETED_ALERT_QUEUE.IDX_TARGETED_ALERT_0001', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_TARGETED_ALERT_QUEUE', @level2type = N'INDEX', @level2name = N'IDX_TARGETED_ALERT_0001';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_TARGETED_ALERT_QUEUE.IDX_TARGETED_ALERT_0008', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_TARGETED_ALERT_QUEUE', @level2type = N'INDEX', @level2name = N'IDX_TARGETED_ALERT_0008';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_TARGETED_ALERT_QUEUE.IDX_TARGETED_ALERT_000A', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_TARGETED_ALERT_QUEUE', @level2type = N'INDEX', @level2name = N'IDX_TARGETED_ALERT_000A';
