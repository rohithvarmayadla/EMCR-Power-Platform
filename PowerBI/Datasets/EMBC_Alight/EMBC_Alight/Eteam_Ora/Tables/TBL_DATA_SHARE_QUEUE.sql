...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_DATA_SHARE_QUEUE.IDX_DATA_SHARE_0001', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_DATA_SHARE_QUEUE', @level2type = N'INDEX', @level2name = N'IDX_DATA_SHARE_0001';
