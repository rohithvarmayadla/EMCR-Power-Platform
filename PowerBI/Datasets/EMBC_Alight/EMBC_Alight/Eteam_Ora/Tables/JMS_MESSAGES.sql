...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.JMS_MESSAGES.JMS_MESSAGES_DESTINATION', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'JMS_MESSAGES', @level2type = N'INDEX', @level2name = N'JMS_MESSAGES_DESTINATION';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.JMS_MESSAGES.JMS_MESSAGES_TXOP_TXID', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'JMS_MESSAGES', @level2type = N'INDEX', @level2name = N'JMS_MESSAGES_TXOP_TXID';
