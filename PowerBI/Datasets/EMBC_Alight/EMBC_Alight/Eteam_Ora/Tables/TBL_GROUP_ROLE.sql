...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_GROUP_ROLE.IDX_GROUP_ROLE_0001', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_GROUP_ROLE', @level2type = N'INDEX', @level2name = N'IDX_GROUP_ROLE_0001';
