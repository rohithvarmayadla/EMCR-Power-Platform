...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."formmetadatatype".FMT_APPLICATIONID', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'formmetadatatype', @level2type = N'INDEX', @level2name = N'FMT_APPLICATIONID';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."formmetadatatype".FMT_MODIFIED', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'formmetadatatype', @level2type = N'INDEX', @level2name = N'FMT_MODIFIED';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."formmetadatatype".FMT_OWNERID', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'formmetadatatype', @level2type = N'INDEX', @level2name = N'FMT_OWNERID';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."formmetadatatype".FMT_TENANTID', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'formmetadatatype', @level2type = N'INDEX', @level2name = N'FMT_TENANTID';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."formmetadatatype".FORMMETADATATYPEDTYPE', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'formmetadatatype', @level2type = N'INDEX', @level2name = N'FORMMETADATATYPEDTYPE';
