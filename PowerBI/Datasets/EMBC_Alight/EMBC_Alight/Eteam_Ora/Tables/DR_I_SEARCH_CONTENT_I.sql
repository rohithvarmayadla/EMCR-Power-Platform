...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.DR$I_SEARCH_CONTENT$I.DR$I_SEARCH_CONTENT$X', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'DR$I_SEARCH_CONTENT$I', @level2type = N'INDEX', @level2name = N'DR$I_SEARCH_CONTENT$X';
