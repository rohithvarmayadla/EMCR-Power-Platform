...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."formsubmissiontype".FORMSUBMISSIONTYPEDTYPE', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'formsubmissiontype', @level2type = N'INDEX', @level2name = N'FORMSUBMISSIONTYPEDTYPE';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."formsubmissiontype".FST_APPLICATIONID', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'formsubmissiontype', @level2type = N'INDEX', @level2name = N'FST_APPLICATIONID';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."formsubmissiontype".FST_CREATED', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'formsubmissiontype', @level2type = N'INDEX', @level2name = N'FST_CREATED';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."formsubmissiontype".FST_FORMTYPEID', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'formsubmissiontype', @level2type = N'INDEX', @level2name = N'FST_FORMTYPEID';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."formsubmissiontype".FST_FORMTYPEVERSION', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'formsubmissiontype', @level2type = N'INDEX', @level2name = N'FST_FORMTYPEVERSION';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."formsubmissiontype".FST_OWNERID', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'formsubmissiontype', @level2type = N'INDEX', @level2name = N'FST_OWNERID';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."formsubmissiontype".FST_TENANTID', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'formsubmissiontype', @level2type = N'INDEX', @level2name = N'FST_TENANTID';
