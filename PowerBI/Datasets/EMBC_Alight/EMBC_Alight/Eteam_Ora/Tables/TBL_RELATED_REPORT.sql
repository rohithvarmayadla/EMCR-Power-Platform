...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_RELATED_REPORT.IDX_RELATED_REP_0001', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_RELATED_REPORT', @level2type = N'INDEX', @level2name = N'IDX_RELATED_REP_0001';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_RELATED_REPORT.IDX_RELATED_REPORT_0001', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_RELATED_REPORT', @level2type = N'INDEX', @level2name = N'IDX_RELATED_REPORT_0001';
