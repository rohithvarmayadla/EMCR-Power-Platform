...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_REMOTE_DOCUMENT_USER_INFO.IDX_REMOTE_DOC_0003', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_REMOTE_DOCUMENT_USER_INFO', @level2type = N'INDEX', @level2name = N'IDX_REMOTE_DOC_0003';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_REMOTE_DOCUMENT_USER_INFO.IDX_REMOTE_DOC_000C', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_REMOTE_DOCUMENT_USER_INFO', @level2type = N'INDEX', @level2name = N'IDX_REMOTE_DOC_000C';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_REMOTE_DOCUMENT_USER_INFO.IDX_REMOTE_DOC_000D', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_REMOTE_DOCUMENT_USER_INFO', @level2type = N'INDEX', @level2name = N'IDX_REMOTE_DOC_000D';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_REMOTE_DOCUMENT_USER_INFO.IDX_REMOTE_DOC_000E', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_REMOTE_DOCUMENT_USER_INFO', @level2type = N'INDEX', @level2name = N'IDX_REMOTE_DOC_000E';
