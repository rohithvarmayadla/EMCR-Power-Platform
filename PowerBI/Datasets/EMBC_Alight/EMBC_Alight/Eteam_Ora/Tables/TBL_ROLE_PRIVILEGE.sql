...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_ROLE_PRIVILEGE.IDX_ROLE_PRIVIL_0001', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_ROLE_PRIVILEGE', @level2type = N'INDEX', @level2name = N'IDX_ROLE_PRIVIL_0001';
