...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."controlsubmissiontype".CONTROLSUBMISSIONTYPEDTYPE', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'controlsubmissiontype', @level2type = N'INDEX', @level2name = N'CONTROLSUBMISSIONTYPEDTYPE';


GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD."controlsubmissiontype".CST_NAME', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'controlsubmissiontype', @level2type = N'INDEX', @level2name = N'CST_NAME';
