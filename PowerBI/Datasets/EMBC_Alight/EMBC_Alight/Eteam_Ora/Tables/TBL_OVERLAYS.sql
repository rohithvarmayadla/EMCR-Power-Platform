...
GO
EXECUTE sp_addextendedproperty @name = N'MS_SSMA_SOURCE', @value = N'EMBCPROD.TBL_OVERLAYS.IDX_OVERLAYS_000B', @level0type = N'SCHEMA', @level0name = N'Eteam_Ora', @level1type = N'TABLE', @level1name = N'TBL_OVERLAYS', @level2type = N'INDEX', @level2name = N'IDX_OVERLAYS_000B';
